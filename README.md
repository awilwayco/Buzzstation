...
## Description 
A React Native app to send commands and receive data to/from blimps with Flask and ROS 2 used for the Backend and React Native and Expo used for the Frontend.
